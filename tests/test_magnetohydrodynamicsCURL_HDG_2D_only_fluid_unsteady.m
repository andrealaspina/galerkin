...
% Geometry and mesh --------------------------------------------------------------------------------
load('../geometry/Mesh_square_1.mat');           % Load mesh
Mesh.Nodes=[Mesh.Nodes(1,:)/2+0.5;...
            Mesh.Nodes(2,:)/2+0.5];
% --------------------------------------------------------------------------------------------------
...
Options.ComputeError=...                         % Compute error
  {'ScaledStrainRate';
   ...
   'LagrangeMultiplier'};
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateErrorL2      -8.968935885158572e-01)<1e-12 && ',...
   'abs(Results.VelocityErrorL2              -4.279488291028057e-01)<1e-12 && ',...
   'abs(Results.PressureErrorL2              -5.819760932597503e-01)<1e-12 && ',...
