...
Simulation.RestartInitialFinalSteps=[5,8];       % Initial and final time steps for restart
Simulation.RestartFileName='test_restart_0';     % Restart file name
% --------------------------------------------------------------------------------------------------
...
Options.Test=...                                 % Test
  ['Results.TemperatureErrorL2  <1e-12 && ',...
   'abs(max(Results.Temperature)-2)<1e-12'];
% --------------------------------------------------------------------------------------------------
