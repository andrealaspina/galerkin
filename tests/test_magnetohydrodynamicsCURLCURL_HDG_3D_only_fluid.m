...
Boundaries.Dirichlet_m=1:18;                     % Dirichlet portion for magnetic field
...
Options.ComputeError=...                         % Compute error
  {'ScaledStrainRate';
   ...
   'LagrangeMultiplier'};
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateErrorL2      -7.647223486858010e-01)<1e-12 && ',...
   'abs(Results.VelocityErrorL2              -1.289709279510233e-01)<1e-12 && ',...
