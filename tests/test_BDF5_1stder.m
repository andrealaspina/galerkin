...
Parameters.Temperature=@(x,y,z,t) (x+y)*t^6;     % Temperature
Parameters.ThermalFlux=@(x,y,z,t) 0*x;           % Thermal flux
Parameters.HeatSource=@(x,y,z,t) (x+y)*6*t^5;    % Heat source
% --------------------------------------------------------------------------------------------------
...
Time.TimeStepSize=1./[4,5];                      % Time step size
Time.BDFOrder=5;                                 % BDF order
% --------------------------------------------------------------------------------------------------
...
Options.Test=...                                 % Test
  'abs(Results.TemperatureErrorL2Rate(end)-Time.BDFOrder)<3e-2';
% --------------------------------------------------------------------------------------------------
