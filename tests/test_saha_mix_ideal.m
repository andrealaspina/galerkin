...
Parameters.MolarMass=[39.948;39.948]*1e-3;       % Molar mass
...
Options.Test=...                                 % Test
  ['abs(Results.AverageChargeState-3.461810360383030e-00                            )<1e-12 && ',...
   'abs(Results.Composition(1,1)  -3.426171348955255e-10*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,1)  -3.426171348955255e-10*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,2)  -2.513744405248731e-05*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,2)  -2.513744405248731e-05*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,3)  -2.933690729260222e-02*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,3)  -2.933690729260222e-02*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,4)  -4.836311208047152e-01*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,4)  -4.836311208047152e-01*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,5)  -4.828163468237952e-01*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,5)  -4.828163468237952e-01*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,6)  -4.190265108859138e-03*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,6)  -4.190265108859138e-03*Parameters.MolarFraction(2))<1e-12 && ',...
   'abs(Results.Composition(1,7)  -2.221833586136860e-07*Parameters.MolarFraction(1))<1e-12 && ',...
   'abs(Results.Composition(2,7)  -2.221833586136860e-07*Parameters.MolarFraction(2))<1e-12 && ',...
