...
Parameters.StabDisplacement=2.5e2;               % Stabilization for displacement
...
Options.ComputeError=...                         % Compute error
  {'Displacement';
   'DisplacementPost'};
Options.Test=...                                 % Test
  ['abs(Results.DisplacementErrorL2    -1.261771279841238e-01)<1e-12 && ',...
   'abs(Results.DisplacementPostErrorL2-1.361414404745252e-01)<1e-12'];
% --------------------------------------------------------------------------------------------------
