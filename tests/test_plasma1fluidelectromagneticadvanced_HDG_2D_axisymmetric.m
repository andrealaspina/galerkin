...
% Geometry and mesh --------------------------------------------------------------------------------
MeshFile={'Mesh_axisymmetric_euler_maxwell_1'};  % Mesh file
% --------------------------------------------------------------------------------------------------
...
Options.Test=...                                 % Test
  ['Results.DensityErrorL2             <1e-11 && ',...
   'Results.MomentumErrorL2            <1e-11 && ',...
