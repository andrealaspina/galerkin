...
Parameters(1).StabDisplacement=2.5e2;            % Stabilization for displacement
Parameters(1).Density=1;                         % Density
Parameters(1).YoungsModulus=@(x,y,z) 25;         % Young's modulus
...
Parameters(2).NitschePenalty=2.5e3;              % Nitsche's penalty parameter
Parameters(2).Density=1;                         % Density
Parameters(2).YoungsModulus=@(x,y,z) 250;        % Young's modulus
...
% Geometry and mesh --------------------------------------------------------------------------------
MeshFile={'Mesh_square_coupled_4parts_2'};       % Mesh file
% --------------------------------------------------------------------------------------------------
...
Options.ComputeError=...                         % Compute error
  {'Displacement';
   'DisplacementPost'};
Options.Test=...                                 % Test
  ['abs(Results(1).DisplacementErrorL2    -1.268947484665224e-01)<1e-12 && ',...
   'abs(Results(1).DisplacementPostErrorL2-1.365742599182946e-01)<1e-12 && ',...
   'abs(Results(2).DisplacementErrorL2    -6.271996067768744e-03)<1e-12'];
% --------------------------------------------------------------------------------------------------
