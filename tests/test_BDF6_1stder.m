...
Parameters.Temperature=@(x,y,z,t) (x+y)*t^7;     % Temperature
Parameters.ThermalFlux=@(x,y,z,t) 0*x;           % Thermal flux
Parameters.HeatSource=@(x,y,z,t) (x+y)*7*t^6;    % Heat source
% --------------------------------------------------------------------------------------------------
...
Time.TimeStepSize=1./[5,6];                      % Time step size
Time.BDFOrder=6;                                 % BDF order
% --------------------------------------------------------------------------------------------------
...
Options.Test=...                                 % Test
  'abs(Results.TemperatureErrorL2Rate(end)-Time.BDFOrder)<4e-2';
% --------------------------------------------------------------------------------------------------
