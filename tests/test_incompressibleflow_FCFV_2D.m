...
Options.ComputeError=...                         % Compute error
  {'ScaledStrainRate';
   ...
   'Pressure'};
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateErrorL2-6.244173389662593e-00)<1e-12 && ',...
   'abs(Results.VelocityErrorL2        -3.876876460280629e-00)<1e-12 && ',...
   'abs(Results.PressureErrorL2        -6.299486269227101e+01)<1e-12'];
% --------------------------------------------------------------------------------------------------
