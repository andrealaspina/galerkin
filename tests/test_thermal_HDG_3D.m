...
Options.ComputeError=...                         % Compute error
  {'ScaledTemperatureGradient';
   ...
   'TemperaturePost'};
Options.Test=...                                 % Test
  ['abs(Results.ScaledTemperatureGradientErrorL2-4.436472886594133e-01)<1e-12 && ',...
   'abs(Results.TemperatureErrorL2              -1.241081690496748e-01)<1e-12 && ',...
   'abs(Results.TemperaturePostErrorL2          -5.463318751542895e-02)<1e-12'];
% --------------------------------------------------------------------------------------------------
