...
Options.ComputeError=...                         % Compute error
  {'ScaledStrainRate';
   ...
   'Pressure'};
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateErrorL2-5.984137365688188e-01)<1e-12 && ',...
   'abs(Results.VelocityErrorL2        -2.507297936682122e-01)<1e-12 && ',...
   'abs(Results.PressureErrorL2        -5.199523857593078e-01)<1e-12'];
% --------------------------------------------------------------------------------------------------
