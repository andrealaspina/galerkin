...
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateCenterErrorNumber-9.480073946500687e-01)<1e-12 && ',...
   'abs(Results.VelocityCenterErrorNumber        -3.812910912112043e-02)<1e-12 && ',...
   'abs(Results.PressureCenterErrorNumber        -6.701061394925092e-02)<1e-12'];
% --------------------------------------------------------------------------------------------------
