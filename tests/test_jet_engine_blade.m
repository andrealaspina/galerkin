...
Options.PlotMesh='no';                           % Plot mesh
Options.Test=...                                 % Test
  ['abs(max(Results.Displacement(:,1))-1.189487031474496e-04)<1e-12 && ',...
   'abs(max(Results.Displacement(:,2))-1.441685663836356e-03)<1e-12 && ',...
   'abs(max(Results.Displacement(:,3))-3.967889621016083e-04)<1e-12'];
% --------------------------------------------------------------------------------------------------
