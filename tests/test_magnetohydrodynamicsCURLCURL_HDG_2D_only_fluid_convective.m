...
Boundaries.Dirichlet_m=1:16;                     % Dirichlet portion for magnetic field
...
Options.Test=...                                 % Test
  ['abs(Results.ScaledStrainRateErrorL2  -3.729485507228658e-01)<1e-12 && ',...
   'abs(Results.VelocityErrorL2          -3.595960620937355e-02)<1e-12 && ',...
   'abs(Results.PressureErrorL2          -4.082658880469975e-02)<1e-12 && ',...
