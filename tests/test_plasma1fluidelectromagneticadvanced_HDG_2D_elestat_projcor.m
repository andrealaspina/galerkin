...
Options.Test=...                                 % Test
  ['abs(Results.DensityErrorL2             -9.208808891727433e-06)<1e-12 && ',...
   'abs(Results.MomentumErrorL2            -2.989312064972083e-04)<1e-12 && ',...
   'abs(Results.EnergyErrorL2              -0.000000000000000e-00)<1e-12 && ',...
   'abs(Results.MagneticFieldErrorL2       -8.736030770955347e+02)<1e-08 && ',...
   'abs(Results.ElectricFieldErrorL2       -3.124878028980792e+03)<1e-08 && ',...
   ...
   'abs(Results.ElectricFieldErrorHcurl    -3.129302676475248e+03)<1e-08 && ',...
   'abs(Results.ElectricFieldPostErrorHcurl-3.124529302707166e+03)<1e-08'];
% --------------------------------------------------------------------------------------------------
