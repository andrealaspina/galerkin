...
Options.Test=...                                 % Test
  ['abs(Results.AverageChargeState-2.088339949452334e-00)<1e-12 && ',...
   'abs(Results.Composition(1)    -5.551632627412836e-02)<1e-12 && ',...
   'abs(Results.Composition(2)    -1.184605480549000e-01)<1e-12 && ',...
   'abs(Results.Composition(3)    -5.081899756155049e-01)<1e-12 && ',...
   'abs(Results.Composition(4)    -3.178331500554426e-01)<1e-12 && ',...
   'abs(Results.Composition(5)    -2.406259028120634e-14)<1e-12 && ',...
   'abs(Results.Composition(6)    -2.266634040397371e-32)<1e-12 && ',...
   'abs(Results.Composition(7)    -1.058077977613979e-55)<1e-12 && ',...
