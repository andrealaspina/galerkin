classdef ElectromagneticFD_HDG_fast < Formulation  
...
% Compute lhs
KHH(ne1,ne1)=-1i*mu*omega*Me;
if nsd==3
  KHH(ne2,ne2)=-1i*mu*omega*Me;
  KHH(ne3,ne3)=-1i*mu*omega*Me;
end
...
Kee(ne1,ne1)=1i*epsilon*omega*Me;
Kee(ne2,ne2)=1i*epsilon*omega*Me;
if nsd==3
  Kee(ne3,ne3)=1i*epsilon*omega*Me;
end
...
% Compute rhs
if nsd==2
  fp(ne1,1)=-NweyT*(1i*mu*omega*Hzeg);
  fp(ne2,1)=+NwexT*(1i*mu*omega*Hzeg);
else
  fp(ne1,1)=+NwezT*(1i*mu*omega*Hyeg)...
            -NweyT*(1i*mu*omega*Hzeg);
  fp(ne2,1)=+NwexT*(1i*mu*omega*Hzeg)...
            -NwezT*(1i*mu*omega*Hxeg);
  fp(ne3,1)=+NweyT*(1i*mu*omega*Hxeg)...
            -NwexT*(1i*mu*omega*Hyeg);
end
