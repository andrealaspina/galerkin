    ...
    if isDirichlet || isInterface
      if nsd==2
        Kuu(nf1,ne1)=Kuu(nf1,ne1)+NwfT*((-dsxxdFxxfg.*nx-dsxxdFxyfg.*ny).*Nxf)...
                                 +NwfT*((-dsxxdFxyfg.*nx-dsxydFxyfg.*ny).*Nyf);
        Kuu(nf1,ne2)=Kuu(nf1,ne2)+NwfT*((-dsxxdFyxfg.*nx-dsxydFyxfg.*ny).*Nxf)...
                                 +NwfT*((-dsxxdFyyfg.*nx-dsxydFyyfg.*ny).*Nyf);
        Kuu(nf2,ne1)=Kuu(nf2,ne1)+NwfT*((-dsxxdFyxfg.*nx-dsxxdFyyfg.*ny).*Nxf)...
                                 +NwfT*((-dsxydFyxfg.*nx-dsxydFyyfg.*ny).*Nyf);
        Kuu(nf2,ne2)=Kuu(nf2,ne2)+NwfT*((-dsyxdFyxfg.*nx-dsyxdFyyfg.*ny).*Nxf)...
                                 +NwfT*((-dsyxdFyyfg.*nx-dsyydFyyfg.*ny).*Nyf);
      elseif nsd==3
        Kuu(nf1,ne1)=Kuu(nf1,ne1)+NwfT*((-dsxxdFxxfg.*nx-dsxxdFxyfg.*ny-dsxxdFxzfg.*nz).*Nxf)...
                                 +NwfT*((-dsxxdFxyfg.*nx-dsxydFxyfg.*ny-dsxydFxzfg.*nz).*Nyf)...
                                 +NwfT*((-dsxxdFxzfg.*nx-dsxydFxzfg.*ny-dsxzdFxzfg.*nz).*Nzf);
        Kuu(nf1,ne2)=Kuu(nf1,ne2)+NwfT*((-dsxxdFyxfg.*nx-dsxydFyxfg.*ny-dsxzdFyxfg.*nz).*Nxf)...
                                 +NwfT*((-dsxxdFyyfg.*nx-dsxydFyyfg.*ny-dsxzdFyyfg.*nz).*Nyf)...
                                 +NwfT*((-dsxxdFyzfg.*nx-dsxydFyzfg.*ny-dsxzdFyzfg.*nz).*Nzf);
        Kuu(nf1,ne3)=Kuu(nf1,ne3)+NwfT*((-dsxxdFzxfg.*nx-dsxydFzxfg.*ny-dsxzdFzxfg.*nz).*Nxf)...
                                 +NwfT*((-dsxxdFzyfg.*nx-dsxydFzyfg.*ny-dsxzdFzyfg.*nz).*Nyf)...
                                 +NwfT*((-dsxxdFzzfg.*nx-dsxydFzzfg.*ny-dsxzdFzzfg.*nz).*Nzf);
        Kuu(nf2,ne1)=Kuu(nf2,ne1)+NwfT*((-dsxxdFyxfg.*nx-dsxxdFyyfg.*ny-dsxxdFyzfg.*nz).*Nxf)...
                                 +NwfT*((-dsxydFyxfg.*nx-dsxydFyyfg.*ny-dsxydFyzfg.*nz).*Nyf)...
                                 +NwfT*((-dsxzdFyxfg.*nx-dsxzdFyyfg.*ny-dsxzdFyzfg.*nz).*Nzf);
        Kuu(nf2,ne2)=Kuu(nf2,ne2)+NwfT*((-dsyxdFyxfg.*nx-dsyxdFyyfg.*ny-dsyxdFyzfg.*nz).*Nxf)...
                                 +NwfT*((-dsyxdFyyfg.*nx-dsyydFyyfg.*ny-dsyydFyzfg.*nz).*Nyf)...
                                 +NwfT*((-dsyxdFyzfg.*nx-dsyydFyzfg.*ny-dsyzdFyzfg.*nz).*Nzf);
        Kuu(nf2,ne3)=Kuu(nf2,ne3)+NwfT*((-dsyxdFzxfg.*nx-dsyydFzxfg.*ny-dsyzdFzxfg.*nz).*Nxf)...
                                 +NwfT*((-dsyxdFzyfg.*nx-dsyydFzyfg.*ny-dsyzdFzyfg.*nz).*Nyf)...
                                 +NwfT*((-dsyxdFzzfg.*nx-dsyydFzzfg.*ny-dsyzdFzzfg.*nz).*Nzf);
        Kuu(nf3,ne1)=Kuu(nf3,ne1)+NwfT*((-dsxxdFzxfg.*nx-dsxxdFzyfg.*ny-dsxxdFzzfg.*nz).*Nxf)...
                                 +NwfT*((-dsxydFzxfg.*nx-dsxydFzyfg.*ny-dsxydFzzfg.*nz).*Nyf)...
                                 +NwfT*((-dsxzdFzxfg.*nx-dsxzdFzyfg.*ny-dsxzdFzzfg.*nz).*Nzf);
        Kuu(nf3,ne2)=Kuu(nf3,ne2)+NwfT*((-dsyxdFzxfg.*nx-dsyxdFzyfg.*ny-dsyxdFzzfg.*nz).*Nxf)...
                                 +NwfT*((-dsyydFzxfg.*nx-dsyydFzyfg.*ny-dsyydFzzfg.*nz).*Nyf)...
                                 +NwfT*((-dsyzdFzxfg.*nx-dsyzdFzyfg.*ny-dsyzdFzzfg.*nz).*Nzf);
        Kuu(nf3,ne3)=Kuu(nf3,ne3)+NwfT*((-dszxdFzxfg.*nx-dszxdFzyfg.*ny-dszxdFzzfg.*nz).*Nxf)...
                                 +NwfT*((-dszxdFzyfg.*nx-dszydFzyfg.*ny-dszydFzzfg.*nz).*Nyf)...
                                 +NwfT*((-dszxdFzzfg.*nx-dszydFzzfg.*ny-dszzdFzzfg.*nz).*Nzf);
      end
    end
