...
if nsd==2
  switch k
    ...
    case 8
      ...
      Mesh.Elements=msh.TRIANGLES45(:,order)';
    otherwise
...
elseif nsd==3
  switch k
    ...
    case 5
      ...
      Mesh.Elements=msh.TETS56(:,order)';
    case 6
      ...
      Mesh.Elements=msh.TETS84(:,order)';
    case 7
